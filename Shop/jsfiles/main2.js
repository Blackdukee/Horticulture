...
let searchbar = document.querySelector("#item-search");
      ...
      searchbar.addEventListener("input",  ()=> {
        ...
        if (searchbar.value.length > 2) {
          searchbar.addEventListener("change", () => {
            $.ajax({
              url: "/Horticulture/Shop/phpfiles/search.php",
              type: "POST",
              data: { search: val },
...
function fetch_data2() {
  return new Promise(function (resolve, reject) {
    $.ajax({
      ...
      url: "/Horticulture/Shop/phpfiles/showfav.php",
      method: "POST",
      data: { id: 1 },
      success: function (data) {
        resolve(data);
...
fetch_data2();
    ...
    function fetch_data(page) {
      ...
      $.ajax({
        url: "/Horticulture/Shop/phpfiles/pagination.php",
        method: "POST",
        headers: {
    ...
    function pressed(heart) {
      ...
      if (heart.classList.contains("fa-regular")) {
        ...
        $.ajax({
          ...
          url: "/Horticulture/Shop/phpfiles/items.php",
          method: "POST",
...
function showitemsincart() {
  ...
  if(valOfInputInItemPage != null) {
      ...
      url: "/Horticulture/Shop/phpfiles/showitemINCART.php",
      method: "POST",
...
$(document).on('click', '.card-textRemove', function () {
  ...
  $.ajax({
    url: "/Horticulture/Shop/phpfiles/RemoveFromCart.php",
    method: "POST",
    data: { id: digit },
    caches: false,
    success: function (data) {
...
$(document).on('click', '[name="addbutton"]', function () {
  ...
  $.ajax({
    url: "/Horticulture/Shop/phpfiles/AddToCart.php",
    method: "POST",
    data: { id: digit },
    success: function (data) {
      showitemsincart();
